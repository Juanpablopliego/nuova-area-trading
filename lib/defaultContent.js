  ...
  SPINE_IMMOBILI: [
    {
      ...
      bonus: { label: 'Alfio AI', value: 'Coaching AI personalizzato incluso' },
    },
    {
      id: 'imm-assessment',
      kind: 'spine',
  ...
  SPINE_IMMOBILI_P2: [
    {
      id: 'imm-rent2rent',
      kind: 'spine',
      title: 'Rent to Rent Live',
      sub: 'Percorso operativo · 2 live a settimana',
      badge: '02',
      accent: 'affitti',
      highlight: true,
      summary: 'Percorso dedicato al Rent to Rent con sessioni live settimanali per entrare subito nel mercato degli affitti.',
      details: [
        'Strategia Rent to Rent applicata',
        'Identificazione immobili e negoziazione',
        'Contratti e accordi commerciali',
        'Gestione operativa e inquilini',
